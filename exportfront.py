"""Export important Frontend code files into one compact text file.

Usage:
  python exportfront.py
  python exportfront.py -o frontendcode.txt
  python exportfront.py --stdout
  python exportfront.py --max-bytes 600000
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Export important frontend files into one compact text file.")
    parser.add_argument(
        "--root",
        default=str(Path(__file__).resolve().parent),
        help="Frontend root folder to export (default: folder containing this script).",
    )
    parser.add_argument(
        "-o",
        "--output",
        default="frontendcode.txt",
        help="Output file path (default: frontendcode.txt in root).",
    )
    parser.add_argument(
        "--max-bytes",
        type=int,
